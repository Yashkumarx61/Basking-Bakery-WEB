...
export default function FloatingWhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-20 md:bottom-6 right-5 md:right-6 z-40 flex items-center justify-center w-14 h-14 min-w-[44px] min-h-[44px] bg-[#25D366] hover:bg-[#20ba5a] text-white rounded-full shadow-2xl hover:scale-110 active:scale-95 transition-all duration-300 group mb-safe"
