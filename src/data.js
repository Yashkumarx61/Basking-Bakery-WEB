...
export const STORE_CONFIG = {
  ...
  address: 'Shop No - 06, Amrapali Zodiac Market, Sector 120, Noida, UP 201301',
...
export const categories = [
  ...
  { id: 'dry-cakes-breads', label: 'Breads & Sourdough' },
...
export const products = [
  ...
  {
    id: 13,
    name: 'Artisan Iced Hazelnut Latte',
    category: 'beverages',
    ...
    rating: 4.8,
    reviewsCount: 54,
    description: 'Freshly pulled double espresso shot blended with chilled milk and roasted hazelnut syrup.',
    ingredients: 'Espresso Beans, Milk, Hazelnut Syrup, Ice',
    shelfLife: 'Consume fresh',
    allergens: 'Contains Milk & Tree Nuts',
    storage: 'Best enjoyed chilled.',
    variants: [
      { label: '350 ml Regular', price: 169 },
      { label: '500 ml Large', price: 219 },
    ],
    bestSeller: true,
    isAvailable: true,
  },
  {
    id: 14,
    name: 'Slow-Brewed Cold Brew Coffee',
    category: 'beverages',
    image: 'https://images.unsplash.com/photo-1517701574526-815347d9018c?auto=format&fit=crop&w=600&q=80',
    isEggless: true,
    isVeg: true,
    rating: 4.9,
    reviewsCount: 38,
    description: '18-hour slow-steeped Arabica coffee over ice. Smooth, low acidity with chocolate notes.',
    ingredients: '100% Arabica Ground Coffee, Filtered Water',
    shelfLife: '24 hours chilled',
    allergens: 'Caffeine',
    storage: 'Keep cold at 2°C–4°C.',
    variants: [
      { label: '300 ml Bottle', price: 149 },
    ],
    bestSeller: false,
    isAvailable: true,
  },
...
// High-credibility Authentic Customer Reviews / Testimonials
export const testimonials = [
  {
    ...
    text: "Ordered their Belgian Chocolate Truffle cake for my sister's birthday on short notice. The sponge was super moist, not overly sweet, and the ganache was pure quality. Found our new family bakery in the neighborhood!",
    verified: true,
  },
  {
    id: 2,
    ...
    rating: 5,
    date: '1 week ago',
    location: 'Amrapali Zodiac',
    text: 'The garlic sourdough and almond croissants are top tier. Crispy, flaky layers with the right buttery balance. You have to grab them fresh around noon before they sell out.',
    verified: true,
  },
  {
    id: 3,
    ...
    rating: 5,
    date: '2 weeks ago',
    location: 'Supertech Capetown',
    text: 'Their custom celebration cakes look even better in real life than in reference photos. Clean finish, neat piping, and delivered right on time in safe packaging.',
    verified: true,
  },
  {
    id: 4,
    ...
    rating: 4.5,
    date: '3 weeks ago',
    location: 'Prateek Laurel',
    text: 'Great coffee and tea-time tea cakes. The blueberry cheesecake slice has a legit biscuit base and smooth texture. Consistent quality every weekend.',
    verified: true,
  },
];
